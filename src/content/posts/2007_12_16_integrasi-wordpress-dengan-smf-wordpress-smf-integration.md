...
legacyUrl: "/blog/2007/12/16/integrasi-wordpress-dengan-smf-wordpress-smf-integration/"
...
<p><img src="/images/2007/12/wp-smf.png" alt="Wordpress SMF Integration" title="" class="rounded-lg my-6 max-w-full h-auto shadow-md" loading="lazy" />Istilah <a href="https://web.archive.org/web/20140915081622/http://www.wordpress.org/" title="Worpress Homepage" target="_blank">WordPress</a> dan <a href="https://web.archive.org/web/20140915081622/http://www.simplemachines.org/" title="Simple Machines Forum Official Website" target="_blank">SMF </a>barangkali sudah tidak asing lagi di telinga kita, terutama bagi orang yang  pernah membuat blog dan maupun forum. Selain gratis, opensource, populer, keduanya juga mudah digunakan pastinya. Tapi yang mau saya tulis di sini bukanlah pengertian maupun perbedaan kedua CMS tersebut, melainkan bagaimana keduanya bisa &#8216;disatukan&#8217; atau istilah kerennya diintegrasikan.</p>
