...
<p>Recent Posts on Editor is WordPress plugin to display recent contents (post, page or custom post type) on WordPress editor metabox. With this plugin you can review what you have just posted, and also you can simply insert those links into current post.</p>

<p>lagi proces review di wp.org</p>

<p>Yang mau icip-icip dulu silakan unduh di http://takien.com/files/recent-posts-on-editor.zip</p>

<p><img src="/images/facebook/fb_18_0_688d462c04.jpg" alt="Upcoming plugin "Recent Posts on Editor" title="Upcoming plugin "Recent Posts on Editor" class="rounded-lg my-6 max-w-full h-auto shadow-md" loading="lazy" /></p>
